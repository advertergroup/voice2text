...
export function AdminTabs({ active, lang = DEFAULT_LOCALE }: { active: string; lang?: string }) {
  ...
  const tabs = [["/admin", "Textos y marca", "textos"], ["/admin/plans", "Planes/Precios", "plans"], ["/admin/faq", "FAQ", "faq"], ["/admin/landings", "Landings SEO", "landings"], ["/admin/manual", "⏳ Cola manual", "manual"], ["/admin/analytics", "📊 Analítica", "analytics"], ["/admin/heatmap", "🖱️ Mapa de calor", "heatmap"], ["/admin/subidas", "📤 Subidas", "subidas"], ["/admin/ads", "🎯 Ads", "ads"]];
  return (
