...
export const GRUPOS_LANDING: Record<string, Record<string, string>> = {
  audio: { en: "audio-to-text", es: "audio-a-texto", it: "audio-in-testo", de: "audio-in-text" },
  mp3: { en: "mp3-to-text", es: "mp3-a-texto", it: "mp3-in-testo", de: "mp3-in-text" },
  youtube: { en: "youtube-to-text", es: "youtube-a-texto", it: "youtube-in-testo", de: "youtube-in-text" },
  tiktok: { en: "tiktok-to-text", es: "tiktok-a-texto", it: "tiktok-in-testo", de: "tiktok-in-text" },
};
