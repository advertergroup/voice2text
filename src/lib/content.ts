...
export const DEFAULT_CONTENT: ContentDef[] = [
  ...
  { key: "checkout.legal", grupo: "Checkout", label: "Texto legal completo (HTML, con enlaces). Vacío = se oculta", value: "Al continuar aceptas nuestros <a href='/terms'>Términos</a>, la <a href='/refund'>Suscripción y reembolsos</a> · <a href='/privacy'>Privacidad</a>", multiline: true, orden: 3 },
